...
window.LibraryData.SHELF_TOPIC_TRANSLATIONS = {
  ...
  'DISENO MULTIMEDIA': 'Multimedia design',
  'LENGUAJES DE PROGRAMACION': 'Programming languages',
  'METODOLOGIA CIENTIFICA': 'Research methods',
  'FILOSOFIA DE LA CIENCIA': 'Philosophy of science',
  'MATEMATICAS - ENSENANZA': 'Mathematics education',
  'MATEMATICAS - FUNDAMENTOS': 'Foundations of mathematics',
  'MATEMATICAS - HISTORIA': 'History of mathematics',
  'LOGICA MATEMATICA': 'Mathematical logic',
  'CIENCIA Y TECNOLOGIA - HISTORIA': 'History of science and technology',
  'MATEMATICAS': 'Mathematics',
  'ALGEBRA': 'Algebra',
  'ALGEBRA LINEAL': 'Linear algebra',
  'TOPOLOGIA': 'Topology',
  'CALCULO': 'Calculus',
  'PRE-CALCULO': 'Pre-calculus',
  'TEORIA DE LOS NUMEROS': 'Number theory',
  'ECUACIONES DIFERENCIALES': 'Differential equations',
  'GEOMETRIA': 'Geometry',
  'PROBABILIDAD': 'Probability',
  'TEORIA DEL JUEGO': 'Game theory',
  'CALCULO VECTORIAL': 'Vector calculus',
  'ANALISIS DE GEOMETRIA': 'Geometric analysis',
  'ANALISIS NUMERICO': 'Numerical analysis',
  'ESTADISTICA': 'Statistics',
  'ANALISIS MULTIVARIABLE': 'Multivariate analysis',
  'OPTIMIZACION': 'Optimization',
  'ASTRONOMIA': 'Astronomy',
  'FISICA': 'Physics',
  'FISICA - BIOGRAFIAS': 'Physicists - biography',
  'RELATIVIDAD': 'Relativity',
  'TEORIA CUANTICA': 'Quantum theory',
  'COSMOLOGIA': 'Cosmology',
  'TOPOGRAFIA': 'Surveying',
  'FISICA - FUNDAMENTOS': 'Fundamentals of physics',
  'ELECTROMAGNETISMO': 'Electromagnetism',
  'MECANICA ESTADISTICA': 'Statistical mechanics',
  'FISICA TERMODINAMICA': 'Thermal physics',
  'ELECTRODINAMICA': 'Electrodynamics',
  'FISICA NUCLEAR': 'Nuclear physics',
  'MECANICA DE FLUIDOS': 'Fluid mechanics',
  'OPTICA': 'Optics',
  'MODELOS NUCLEARES': 'Nuclear models',
  'QUIMICA GENERAL': 'General chemistry',
  'ANALISIS QUIMICO': 'Chemical analysis',
  'QUIMICA INORGANICA': 'Inorganic chemistry',
  'QUIMICA ORGANICA': 'Organic chemistry',
  'FISICOQUIMICA': 'Physical chemistry',
  'QUIMICA TERMODINAMICA': 'Chemical thermodynamics',
  'MACROMOLECULAS': 'Macromolecules',
  'MINERALES': 'Mineralogy',
  'GEOLOGIA': 'Geology',
  'ANTROPOLOGIA BIOLOGICA': 'Biological anthropology',
  'BIOLOGIA': 'Biology',
  ...
  'DIBUJO EN INGENIERIA': 'Engineering drawing',
  'HISTORIA DE LA TECNOLOGIA': 'History of technology',
  'INGENIERIA BIOMEDICA': 'Biomedical engineering',
  ...
  'MAMIFEROS': 'Mammals',
  'AVES': 'Birds',
  'FISIOLOGIA MEDICA': 'Human physiology',
  ...
  'MICROBIOLOGIA MEDICA': 'Medical microbiology',
  'PSIQUIATRIA': 'Psychiatry',
  'ENFERMEDADES INFECCIOSAS': 'Infectious diseases',
  'PEDIATRIA': 'Pediatrics',
  'MATERIALES': 'Materials',
  'MECANICA APLICADA': 'Applied mechanics',
  'MECANICA DE MATERIALES': 'Strength of materials',
  'COMPOSICION DE MATERIALES': 'Materials science',
  'INGENIERIA': 'Engineering',
  'DISENO DE INGENIERIA': 'Engineering design',
  'INGENIERIA MECANICA': 'Mechanical engineering',
  'INGENIERIA DE POLIMEROS': 'Polymer engineering',
  'NANOTECNOLOGIA': 'Nanotechnology',
  'INGENIERIA ELECTRICA': 'Electrical engineering',
  'TELECOMUNICACIONES': 'Telecommunications',
  'MICROELECTRONICA': 'Microelectronics',
  'ELECTRONICA': 'Electronics',
  'COMUNICACION DIGITAL': 'Digital communications',
  'CIRCUITOS ELECTRICOS': 'Electrical circuits',
  'PROCESAMIENTO DE SENALES': 'Signal processing',
  'DISENO DIGITAL': 'Digital design',
  'TERMODINAMICA': 'Thermodynamics',
  'INGENIERIA CIVIL': 'Civil engineering',
  'MECANICA DE SUELOS': 'Soil mechanics',
  'INGENIERIA DE CARRETERAS': 'Transportation engineering',
  'DISENO DE ESTRUCTURAS': 'Structural design',
  'INGENIERIA DE PETROLEOS': 'Petroleum engineering',
  'INGENIERIA HIDRAULICA': 'Hydraulics',
  'INGENIERIA AMBIENTAL': 'Environmental engineering',
  'INGENIERIA DEL AGUA': 'Water resources engineering',
  'GESTION DE RESIDUOS': 'Waste management',
  'INGENIERIA AUTOMOTRIZ': 'Automotive engineering',
  'SISTEMAS DE CONTROL Y ROBOTICA': 'Control systems and robotics',
  ...
  'PROCESOS QUIMICOS': 'Chemical process engineering',
  'QUIMICA INDUSTRIAL': 'Industrial chemistry',
  ...
  'CONSTRUCCION Y ACABADOS': 'Building construction',
...
window.LibraryData.SHELF_TOPICS = [
  { topics: ['SIMULACION', 'ARQUITECTURA DE SOFTWARE'], shelf: '01' },
  { topics: ['REDES Y CONECTIVIDAD', 'INTELIGENCIA ARTIFICIAL'], shelf: '01' },
  { topics: ['SISTEMAS OPERATIVOS', 'BASES DE DATOS'], shelf: '02' },
  { topics: ['SEGURIDAD INFORMATICA', 'INTELIGENCIA ARTIFICIAL', 'DISENO MULTIMEDIA'], shelf: '02' },
  { topics: ['LENGUAJES DE PROGRAMACION', 'SISTEMAS OPERATIVOS'], shelf: '02' },
  { topics: ['METODOLOGIA CIENTIFICA', 'FILOSOFIA DE LA CIENCIA'], shelf: '02' },
  { topics: ['MATEMATICAS - ENSENANZA', 'MATEMATICAS - FUNDAMENTOS'], shelf: '03' },
  { topics: ['MATEMATICAS - HISTORIA', 'LOGICA MATEMATICA'], shelf: '03' },
  { topics: ['CIENCIA Y TECNOLOGIA - HISTORIA', 'MATEMATICAS'], shelf: '03' },
  { topics: ['ALGEBRA', 'ALGEBRA LINEAL'], shelf: '03' },
  { topics: ['TOPOLOGIA', 'CALCULO'], shelf: '04' },
  { topics: ['CALCULO', 'PRE-CALCULO'], shelf: '04' },
  { topics: ['ALGEBRA LINEAL', 'TEORIA DE LOS NUMEROS', 'TOPOLOGIA'], shelf: '04' },
  { topics: ['CALCULO', 'ECUACIONES DIFERENCIALES'], shelf: '04' },
  { topics: ['GEOMETRIA', 'PROBABILIDAD'], shelf: '05' },
  { topics: ['PROBABILIDAD', 'TEORIA DEL JUEGO'], shelf: '05' },
  { topics: ['CALCULO VECTORIAL', 'ANALISIS DE GEOMETRIA'], shelf: '05' },
  { topics: ['TEORIA DEL JUEGO', 'ANALISIS NUMERICO', 'PROBABILIDAD'], shelf: '05' },
  { topics: ['ESTADISTICA', 'ANALISIS MULTIVARIABLE'], shelf: '06' },
  { topics: ['OPTIMIZACION', 'ASTRONOMIA'], shelf: '07' },
  { topics: ['FISICA'], shelf: '08' },
  { topics: ['FISICA - BIOGRAFIAS', 'RELATIVIDAD', 'TEORIA CUANTICA'], shelf: '08' },
  { topics: ['COSMOLOGIA', 'TOPOGRAFIA', 'FISICA - FUNDAMENTOS'], shelf: '08' },
  { topics: ['TEORIA CUANTICA', 'ELECTROMAGNETISMO'], shelf: '08' },
  { topics: ['MECANICA ESTADISTICA', 'FISICA TERMODINAMICA', 'ELECTROMAGNETISMO'], shelf: '09' },
  { topics: ['ELECTRODINAMICA', 'FISICA NUCLEAR'], shelf: '09' },
  { topics: ['MECANICA DE FLUIDOS', 'OPTICA'], shelf: '09' },
  { topics: ['MODELOS NUCLEARES', 'QUIMICA GENERAL'], shelf: '09' },
  { topics: ['ANALISIS QUIMICO', 'QUIMICA INORGANICA'], shelf: '10' },
  { topics: ['QUIMICA ORGANICA'], shelf: '10' },
  { topics: ['FISICOQUIMICA', 'QUIMICA TERMODINAMICA'], shelf: '10' },
  { topics: ['MACROMOLECULAS', 'MINERALES', 'GEOLOGIA'], shelf: '10' },
  { topics: ['ANTROPOLOGIA BIOLOGICA', 'BIOLOGIA'], shelf: '11' },
  { topics: ['BIOESTADISTICA'], shelf: '11' },
  { topics: ['METEOROLOGIA', 'GEOQUIMICA'], shelf: '11' },
  { topics: ['BIOQUIMICA', 'ECOLOGIA'], shelf: '11' },
  { topics: ['MICROBIOLOGIA', 'BOTANICA'], shelf: '12' },
  { topics: ['FITOPATOLOGIA'], shelf: '12' },
  { topics: ['BIOLOGIA MOLECULAR', 'GENETICA', 'MICROBIOLOGIA'], shelf: '12' },
  { topics: ['MICOLOGIA', 'ZOOLOGIA', 'INVERTEBRADOS'], shelf: '12' },
  { topics: ['DIBUJO EN INGENIERIA', 'HISTORIA DE LA TECNOLOGIA', 'INGENIERIA BIOMEDICA'], shelf: '13' },
  { topics: ['MEDICINA SOCIAL', 'ANATOMIA', 'HISTOLOGIA'], shelf: '13' },
  { topics: ['INSECTOS', 'MAMIFEROS', 'AVES'], shelf: '13' },
  { topics: ['FISIOLOGIA MEDICA', 'NEUROCIENCIA', 'MEDICINA FORENSE'], shelf: '13' },
  { topics: ['PATOLOGIA', 'INMUNOLOGIA', 'HEMATOLOGIA'], shelf: '14' },
  { topics: ['NEUROLOGIA', 'PSICOLOGIA CLINICA'], shelf: '14' },
  { topics: ['FARMACOLOGIA', 'SALUD PUBLICA', 'MICROBIOLOGIA MEDICA'], shelf: '14' },
  { topics: ['PSIQUIATRIA', 'ENFERMEDADES INFECCIOSAS', 'PEDIATRIA'], shelf: '14' },
  { topics: ['MATERIALES', 'MECANICA APLICADA'], shelf: '15' },
  { topics: ['MECANICA DE MATERIALES', 'COMPOSICION DE MATERIALES'], shelf: '15' },
  { topics: ['INGENIERIA', 'DISENO DE INGENIERIA', 'INGENIERIA MECANICA'], shelf: '15' },
  { topics: ['INGENIERIA DE POLIMEROS', 'NANOTECNOLOGIA', 'INGENIERIA ELECTRICA'], shelf: '15' },
  { topics: ['TELECOMUNICACIONES', 'MICROELECTRONICA'], shelf: '16' },
  { topics: ['ELECTRONICA', 'COMUNICACION DIGITAL'], shelf: '16' },
  { topics: ['CIRCUITOS ELECTRICOS', 'PROCESAMIENTO DE SENALES'], shelf: '16' },
  { topics: ['DISENO DIGITAL', 'TERMODINAMICA'], shelf: '16' },
  { topics: ['INGENIERIA CIVIL', 'MECANICA DE SUELOS'], shelf: '17' },
  { topics: ['INGENIERIA DE CARRETERAS', 'DISENO DE ESTRUCTURAS'], shelf: '17' },
  { topics: ['INGENIERIA MECANICA', 'INGENIERIA DE PETROLEOS', 'INGENIERIA HIDRAULICA'], shelf: '17' },
  { topics: ['INGENIERIA HIDRAULICA', 'INGENIERIA AMBIENTAL'], shelf: '17' },
  { topics: ['INGENIERIA DEL AGUA', 'GESTION DE RESIDUOS'], shelf: '18' },
  { topics: ['INGENIERIA AMBIENTAL', 'INGENIERIA AUTOMOTRIZ', 'SISTEMAS DE CONTROL Y ROBOTICA'], shelf: '19' },
  { topics: ['AGRICULTURA', 'ZOOTECNIA', 'GASTRONOMIA'], shelf: '19' },
  { topics: ['GASTRONOMIA', 'CONTABILIDAD', 'ADMINISTRACION'], shelf: '20' },
  { topics: ['TOMA DE DECISIONES', 'GERENCIA DE PROYECTOS', 'ADMINISTRACION DE OPERACIONES'], shelf: '20' },
  { topics: ['MERCADEO', 'INGENIERIA QUIMICA', 'PROCESOS QUIMICOS'], shelf: '21' },
  { topics: ['QUIMICA INDUSTRIAL', 'TECNOLOGIA DE ALIMENTOS', 'PETROLEO'], shelf: '21' },
  { topics: ['PLASTICOS', 'POLIMEROS', 'METALURGIA'], shelf: '22' },
  { topics: ['MANUFACTURA', 'CONSTRUCCION Y ACABADOS', 'LIBROS DE GRAN FORMATO'], shelf: '22' }
];
