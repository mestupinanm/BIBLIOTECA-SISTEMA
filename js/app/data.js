...
window.LibraryData.MAP_COORDS = {
  ...
  shelf_01_single: { x: 9, y: 35 },
  shelf_02_small: { x: 13.4, y: 35 },
  shelf_02_large: { x: 16.6, y: 35 },
  shelf_03_small: { x: 19.4, y: 35 },
  shelf_03_large: { x: 22.6, y: 35 },
  shelf_04_small: { x: 25.4, y: 35 },
  shelf_04_large: { x: 28.6, y: 35 },
  shelf_05_small: { x: 31.4, y: 35 },
  shelf_05_large: { x: 34.6, y: 35 },
  shelf_06_single: { x: 9, y: 58 },
  shelf_07_single: { x: 15, y: 58 },
  shelf_08_small: { x: 19.4, y: 58 },
  shelf_08_large: { x: 22.6, y: 58 },
  shelf_09_small: { x: 25.4, y: 58 },
  shelf_09_large: { x: 28.6, y: 58 },
  shelf_10_small: { x: 31.4, y: 58 },
  shelf_10_large: { x: 34.6, y: 58 },
  shelf_11_small: { x: 37.4, y: 45 },
  shelf_11_large: { x: 40.6, y: 45 },
  shelf_12_small: { x: 52.4, y: 30 },
  shelf_12_large: { x: 55.6, y: 30 },
  shelf_13_small: { x: 59.4, y: 30 },
  shelf_13_large: { x: 62.6, y: 30 },
  shelf_14_small: { x: 65.4, y: 30 },
  shelf_14_large: { x: 68.6, y: 30 },
  shelf_15_small: { x: 71.4, y: 30 },
  shelf_15_large: { x: 74.6, y: 30 },
  shelf_16_small: { x: 77.4, y: 30 },
  shelf_16_large: { x: 80.6, y: 30 },
  shelf_17_small: { x: 52.4, y: 55 },
  shelf_17_large: { x: 55.6, y: 55 },
  shelf_18_single: { x: 61, y: 55 },
  shelf_19_small: { x: 65.4, y: 55 },
  shelf_20_small: { x: 71.4, y: 55 },
  shelf_21_small: { x: 77.4, y: 55 },
  shelf_22_small: { x: 83.4, y: 55 }
};
