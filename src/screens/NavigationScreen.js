...
(function () {
  ...
  var CATEGORIES = [
    {
      ...
      icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect></svg>',
      items: [
    ...
    },
    {
      ...
      icon: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>',
      items: [
  ...
  function buildCategories() {
    ...
    for (var c = 0; c < CATEGORIES.length; c++) {
      ...
      html += '<section class="nav-category" data-cat="' + cat.id + '">';
      html += '  <header class="nav-category-header">';
      html += '    <div class="nav-category-badge">' + cat.icon + '</div>';
      html += '    <div class="nav-category-copy">';
      html += '      <h3 data-i18n="' + cat.titleKey + '">' + PepperLib.i18n.t(cat.titleKey) + '</h3>';
